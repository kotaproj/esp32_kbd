...
static void vProcCtlCmdSw_DOWN(uint32_t ulCode)
{
    ...
    case SW_CODE_NO4:
        ...
        xSendKbdQueue_Code(UID_CTL, KBD_CODE_KEY_DOWN, 3);
        break;

    case SW_CODE_NO5:
        vPrintCtlSw("vProcCtlCmdSw_DOWN_CODE_NO5", __func__, __FILE__);
        xSendKbdQueue_Code(UID_CTL, KBD_CODE_KEY_DOWN, 4);
        break;

    case SW_CODE_NO6:
        vPrintCtlSw("vProcCtlCmdSw_DOWN_CODE_NO6", __func__, __FILE__);
        xSendKbdQueue_Code(UID_CTL, KBD_CODE_KEY_DOWN, 5);
        break;

    case SW_CODE_NO7:
        vPrintCtlSw("vProcCtlCmdSw_DOWN_CODE_NO7", __func__, __FILE__);
        xSendKbdQueue_Code(UID_CTL, KBD_CODE_KEY_DOWN, 6);
        break;

    case SW_CODE_NO8:
        vPrintCtlSw("vProcCtlCmdSw_DOWN_CODE_NO8", __func__, __FILE__);
        xSendKbdQueue_Code(UID_CTL, KBD_CODE_KEY_DOWN, 7);
        break;
...
static void vProcCtlCmdSw_UP(uint32_t ulCode)
{
    ...
    case SW_CODE_NO4:
        ...
        xSendKbdQueue_Code(UID_CTL, KBD_CODE_KEY_UP, 3);
        break;

    case SW_CODE_NO5:
        vPrintCtlSw("vProcCtlCmdSw_UP_CODE_NO5", __func__, __FILE__);
        xSendKbdQueue_Code(UID_CTL, KBD_CODE_KEY_UP, 4);
        break;

    case SW_CODE_NO6:
        vPrintCtlSw("vProcCtlCmdSw_UP_CODE_NO6", __func__, __FILE__);
        xSendKbdQueue_Code(UID_CTL, KBD_CODE_KEY_UP, 5);
        break;

    case SW_CODE_NO7:
        vPrintCtlSw("vProcCtlCmdSw_UP_CODE_NO7", __func__, __FILE__);
        xSendKbdQueue_Code(UID_CTL, KBD_CODE_KEY_UP, 6);
        break;

    case SW_CODE_NO8:
        vPrintCtlSw("vProcCtlCmdSw_UP_CODE_NO8", __func__, __FILE__);
        xSendKbdQueue_Code(UID_CTL, KBD_CODE_KEY_UP, 7);
        break;
